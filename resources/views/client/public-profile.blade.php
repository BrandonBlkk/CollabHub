    ...
    <div class="max-w-5xl mx-auto space-y-3">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
            <div class="flex space-x-6 overflow-x-auto select-none border-b border-gray-200 pb-2">
                <button type="button" class="profile-tab pb-2 text-sm font-medium border-b-2 border-blue-600 text-blue-600"
            ...
            <div id="tab-home" class="profile-tab-content pt-4">
                <p class="text-sm text-gray-700">Browse this client profile and switch to the Jobs tab to see all posted
                    jobs.</p>
            </div>
                                ...
                                <div class="p-6 flex-1 flex flex-col">
                                    <div class="flex items-start justify-between mb-4">
                                        <div class="flex-1">
                                            ...
                                            @php
                                                $skills = is_array($job->skills_required) ? $job->skills_required : [];
                                                $durationMap = [
                                                ...
                                                $durationLabel = $durationMap[$job->duration] ?? 'Not specified';
                                            @endphp
                                        ...
                                        <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                                            <div
                                                ...
                                                <div class="flex items-center">
                                                    ...
                                                    <span class="text-gray-600 text-sm">{{ $durationLabel }}</span>
                                                </div>
                                            </div>
                                            <button type="button"
