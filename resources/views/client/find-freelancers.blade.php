    ...
    <div x-data="filterState()" class="space-y-3">
        ...
        <div class="flex items-center justify-between bg-white rounded-xl shadow-sm border border-gray-200 p-4">
            ...
            <button @click="showFilters = !showFilters"
                ...
                <svg class="w-4 h-4 transition-transform duration-300" :class="{ 'rotate-180': showFilters }" fill="none"
        ...
        <div class="flex flex-col xl:flex-row gap-3">
            ...
            <div x-show="showFilters" x-transition:enter="transition ease-out duration-200"
                ...
                x-transition:leave="transition ease-in" x-transition:leave-start="opacity-100 translate-x-0"
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="filter-group">
                            <div @click="toggleFilter('categories')"
                                ...
                                <svg class="w-4 h-4 transition-transform duration-300 flex-shrink-0 ml-2"
                                    :class="{ 'rotate-180': openFilters.includes('categories') }" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M19 9l-7 7-7-7" />
                                </svg>
                            </div>
                            <div x-show="openFilters.includes('categories')" x-transition class="mt-2 space-y-2">
                        ...
                        <div class="filter-group">
                            <div @click="toggleFilter('hourlyRate')"
                                ...
                                <svg class="w-4 h-4 transition-transform duration-300 flex-shrink-0 ml-2"
                                    :class="{ 'rotate-180': openFilters.includes('hourlyRate') }" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M19 9l-7 7-7-7" />
                                </svg>
                            </div>
                            <div x-show="openFilters.includes('hourlyRate')" x-transition class="mt-2 space-y-2">
                                <label class="flex items-center text-xs">
                        ...
                        <div class="filter-group">
                            <div @click="toggleFilter('experience')"
                                ...
                                <svg class="w-4 h-4 transition-transform duration-300 flex-shrink-0 ml-2"
                                    :class="{ 'rotate-180': openFilters.includes('experience') }" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M19 9l-7 7-7-7" />
                                </svg>
                            </div>
                            <div x-show="openFilters.includes('experience')" x-transition class="mt-2 space-y-2">
                                <label class="flex items-center text-xs">
                        ...
                        <div class="filter-group">
                            <div @click="toggleFilter('location')"
                                ...
                                <span>Location</span>
                                <svg class="w-4 h-4 transition-transform duration-300 flex-shrink-0 ml-2"
                                    :class="{ 'rotate-180': openFilters.includes('location') }" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M19 9l-7 7-7-7" />
                                </svg>
                            </div>
                            <div x-show="openFilters.includes('location')" x-transition class="mt-2 space-y-2">
                                <label class="flex items-center text-xs">
                        ...
                        <div class="filter-group">
                            <div @click="toggleFilter('skills')"
                                ...
                                <svg class="w-4 h-4 transition-transform duration-300 flex-shrink-0 ml-2"
                                    :class="{ 'rotate-180': openFilters.includes('skills') }" fill="none"
                                    stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M19 9l-7 7-7-7" />
                                </svg>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 mb-3">
                    <div class="flex items-center justify-between">
                        <div class="text-sm text-gray-600">
                            ...
                            freelancers
                            <span x-show="hasActiveFilters" class="ml-2 text-blue-600 text-xs font-medium">
                                (Filtered)
                            </span>
                        </div>
                        <div class="flex items-center space-x-2">
