...
@section('title', 'Freelancer Management')
@section('description', 'Manage all registered freelancers and their information')
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            <td class="px-6 py-4">
                                <div class="flex items-center">
                                    <div class="flex items-center gap-2">
                                        <input type="checkbox" value="1" x-model="selectedFreelancers"
                                            class="rounded border-gray-300">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <div class="flex flex-wrap gap-1 mt-1">
                                    <span class="px-2 py-1 text-xs bg-blue-100 text-blue-800 rounded-full">Figma</span>
                                    <span class="px-2 py-1 text-xs bg-blue-100 text-blue-800 rounded-full">React</span>
                                    <span class="px-2 py-1 text-xs bg-blue-100 text-blue-800 rounded-full">Tailwind</span>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm font-medium text-gray-900">
