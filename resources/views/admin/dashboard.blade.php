...
<head>
    ...
    <title>Admin Dashboard | Data Management | CollabHub</title>
            ...
            <header class="bg-white border-b border-gray-200 px-3 py-4">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-sm text-gray-600">Manage platform data and settings</p>
                    </div>
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div class="hidden md:block">
                                ...
                                <p class="text-xs text-gray-500">admin@collabhub.com</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div x-show="activeTab === 'universities'" x-transition>
                            ...
                            <div class="bg-gray-50 border border-gray-200 rounded-xl p-6 mb-6">
                                ...
                                <div class="flex justify-end gap-3 mt-6">
                                    <button
                                        class="px-5 py-2.5 border border-gray-300 rounded-lg hover:bg-gray-50 transition text-sm">
                                        Cancel
                                    </button>
                                    <button
                        ...
                        <div x-show="activeTab === 'skills'" x-transition>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                                ...
                                <div
                                    ...
                                    <div
                                        class="w-10 h-10 bg-gray-100 rounded-lg flex items-center justify-center mb-3">
                        ...
                        <div class="flex items-start gap-3 p-3 hover:bg-gray-50 rounded-lg transition">
                            ...
                            <div class="flex-1 min-w-0">
                                <p class="text-sm text-gray-900">
                                    <span class="font-medium">Admin User</span> added a new major: <span
                                        class="font-medium">Data Science</span>
                                </p>
